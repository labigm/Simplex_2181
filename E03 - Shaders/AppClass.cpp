 ...
 * Prof. Bobadilla, IGME-309-02
 * 12 September 2018
 * Exercise 03: OpenGL Shaders
 * I modified this program to work with a new Fragment Shader, BasicColorComplementary.fs,
 * which takes the complement of the input color.
 */
#include "AppClass.h"
//Application Class
...
{
	// Read in a different fragment shader, BasicColorComplementary.fs, instead of just BasicColor.
...
void AppClass::Display(void)
{
	...
	// Send a variable to the graphics card -- Complement, which, in the shader, specifies that we want to take the complement of the color input just above this line.
	GLuint Complement = glGetUniformLocation(m_uShaderProgramID, "Complement");
	glUniform1i(Complement, true);
