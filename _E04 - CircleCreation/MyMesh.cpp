...
void MyMesh::GenerateCircle(float a_fRadius, int a_nSubdivisions, vector3 a_v3Color)
{
	...
	*/
	...
	float step = (2.0f*M_PI) / (float)a_nSubdivisions;
	...
	{
		/*Old formula
		point1.x = (0 + a_fRadius * cos((360/a_nSubdivisions)*(M_PI/180)));
		point1.y = (0 + a_fRadius * sin((360 / a_nSubdivisions)*(M_PI / 180)));
		point2.x = (0 + a_fRadius * cos((360 / a_nSubdivisions)*(M_PI / 180)));
		point2.y = (0 + a_fRadius * sin((360 / a_nSubdivisions)*(M_PI / 180)));
		point3.x = (0  + a_fRadius * cos((360 / a_nSubdivisions)*(M_PI / 180)));
		point3.y = (0 + a_fRadius * sin((360 / a_nSubdivisions)*(M_PI / 180)));
		*/
		...
		AddTri(point1, point2, point3);//creating tri to build circle
	}
